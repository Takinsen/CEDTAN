...
export function ThreatFamilies() {
  return (
    <svg
      viewBox="0 0 620 254"
      role="img"
      aria-label="ภัยเก้าอย่างในสไลด์ แบ่งเป็นสามกลุ่ม คือโปรแกรมมุ่งร้ายที่เข้ามารันในเครื่อง การหลอกลวงที่ให้เรากดเอง และการยึดเครื่องกับยึดตัวตน"
      className="mx-auto h-auto w-full min-w-[590px]"
      fill="currentColor"
    >
      <text x="310" y="24" textAnchor="middle" fontSize="11" opacity="0.8">
        เก้าอย่างในสไลด์หน้า 4 จัดกลุ่มตามวิธีที่มันเข้าถึงเรา
      </text>
      ...
      <text x="310" y="240" textAnchor="middle" fontSize="11" opacity="0.78">
        สไลด์ปิดหน้านั้นไว้ว่า คนส่วนใหญ่ไม่รู้จักพวกนี้เลย
      </text>
    </svg>
  );
}
