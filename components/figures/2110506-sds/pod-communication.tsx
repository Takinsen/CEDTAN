...
export function PodCommunication() {
  return (
    ...
    >
      ...
      <rect x="10" y="30" width="290" height="185" rx="10" fill="none" stroke="currentColor" strokeOpacity="0.3" />
      <rect x="320" y="30" width="290" height="185" rx="10" fill="none" stroke="currentColor" strokeOpacity="0.3" />

      <rect x="30" y="66" width="250" height="120" rx="10" fillOpacity="0.06" stroke="currentColor" strokeOpacity="0.5" />
      <text x="155" y="180" textAnchor="middle" fontSize="10" fontWeight="600" opacity="0.8">
        Pod A
      </text>

      <rect x="46" y="84" width="98" height="46" rx="7" fillOpacity="0.16" stroke="currentColor" strokeOpacity="0.5" />
      <text x="95" y="103" textAnchor="middle" fontSize="9.5">
        front-end
      </text>
      <text x="95" y="119" textAnchor="middle" fontSize="9" fontFamily="monospace" opacity="0.78">
        :8000
      </text>

      <rect x="166" y="84" width="98" height="46" rx="7" fillOpacity="0.16" stroke="currentColor" strokeOpacity="0.5" />
      <text x="215" y="103" textAnchor="middle" fontSize="9.5">
        back-end
      </text>
      <text x="215" y="119" textAnchor="middle" fontSize="9" fontFamily="monospace" opacity="0.78">
        :9000
      </text>
      ...
      <text x="155" y="152" textAnchor="middle" fontSize="9" fontFamily="monospace" opacity="0.85">
        localhost:9000
      </text>
      <text x="155" y="166" textAnchor="middle" fontSize="9" fontFamily="monospace" opacity="0.7">
        หรือ svc_a:9000
      </text>

      <rect x="200" y="42" width="90" height="22" rx="5" fillOpacity="0.2" stroke="currentColor" strokeOpacity="0.5" />
      <text x="245" y="57" textAnchor="middle" fontSize="9" fontFamily="monospace">
        svc_a
      </text>

      <rect x="336" y="76" width="112" height="100" rx="10" fillOpacity="0.06" stroke="currentColor" strokeOpacity="0.5" />
      <text x="392" y="170" textAnchor="middle" fontSize="10" fontWeight="600" opacity="0.8">
        Pod A
      </text>
      <rect x="348" y="92" width="88" height="42" rx="6" fillOpacity="0.16" stroke="currentColor" strokeOpacity="0.5" />
      <text x="392" y="109" textAnchor="middle" fontSize="9.5">
        front-end
      </text>
      <text x="392" y="124" textAnchor="middle" fontSize="9" fontFamily="monospace" opacity="0.78">
        :8000
      </text>

      <rect x="484" y="76" width="112" height="100" rx="10" fillOpacity="0.06" stroke="currentColor" strokeOpacity="0.5" />
      <text x="540" y="170" textAnchor="middle" fontSize="10" fontWeight="600" opacity="0.8">
        Pod B
      </text>
      <rect x="496" y="92" width="88" height="42" rx="6" fillOpacity="0.16" stroke="currentColor" strokeOpacity="0.5" />
      <text x="540" y="109" textAnchor="middle" fontSize="9.5">
        back-end
      </text>
      <text x="540" y="124" textAnchor="middle" fontSize="9" fontFamily="monospace" opacity="0.78">
        :9000
      </text>

      <rect x="420" y="42" width="88" height="22" rx="5" fillOpacity="0.2" stroke="currentColor" strokeOpacity="0.5" />
      <text x="464" y="57" textAnchor="middle" fontSize="9" fontFamily="monospace">
        svc_b
      </text>
      ...
      <text x="465" y="196" textAnchor="middle" fontSize="9" fontFamily="monospace" opacity="0.85">
        svc_b:9000 เท่านั้น
      </text>

      <text x="310" y="240" textAnchor="middle" fontSize="10.5" opacity="0.78">
