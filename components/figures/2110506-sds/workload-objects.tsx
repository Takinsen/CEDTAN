...
export function WorkloadObjects() {
  return (
    <svg
      ...
      fill="currentColor"
    >
      <text x="90" y="24" textAnchor="middle" fontSize="11" fontWeight="600" opacity="0.8">
        ชนิด
      </text>
      <text x="290" y="24" textAnchor="middle" fontSize="11" fontWeight="600" opacity="0.8">
        ใช้เมื่อ
      </text>
      <text x="500" y="24" textAnchor="middle" fontSize="11" fontWeight="600" opacity="0.8">
        ตัวอย่าง
      </text>
      <line x1="15" y1="32" x2="605" y2="32" stroke="currentColor" strokeOpacity="0.5" strokeWidth="1" />
      ...
      {KINDS.map((k, i) => {
        ...
        return (
          <g key={k.name}>
            ...
            <rect x="24" y={y + 5} width="132" height="22" rx="4" fillOpacity="0.18" stroke="currentColor" strokeOpacity="0.5" />
            <text x="90" y={y + 20} textAnchor="middle" fontSize="11" fontWeight="600">
              {k.name}
            </text>
            <text x="176" y={y + 20} fontSize="11" opacity="0.85">
              {k.when}
            </text>
            <text x="400" y={y + 20} fontSize="11" opacity="0.75">
              {k.shape}
            </text>
          </g>
        );
