...
sidebarTitle: "3 · Multi-container Apps"
lecture: 3
...
คำสั่งเรียงตามลำดับที่ใช้จริง เริ่มจากสามตัวที่แทบทุกไฟล์ต้องมี
...
<Example title="หกกรณี — image ฐานคือ alpine:3.23">
...
<Pitfall>
**`EXPOSE` ไม่ใช่ `-p`** เขียนไว้ตรง ๆ ว่า `expose ≠ publish`
...
มีสองเรื่อง และทั้งสองเป็นความผิดพลาดที่พบบ่อยมาก
...
ขั้นตอนพัฒนาแอปแบบ Docker มีเจ็ดขั้น
