...
ประโยคที่เขียนกำกับไว้คือ **working independently most of the time** — สังเกตคำว่า *most* ไม่ใช่ *all* ยังมีเวลาที่ต้องคุยกัน เช่นตอนจะเปลี่ยนสัญญาของ API
...
ตัวอย่างที่ยกมาคือระบบแบบ Grab หรือ Uber ที่
...
ตัวอย่างที่ยกมาคือหน้ารายละเอียดสินค้าของ Amazon หน้าจอเดียวนั้นต้องดึงข้อมูลจากหกบริการ
